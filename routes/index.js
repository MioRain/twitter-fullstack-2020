...
const chatController = require('../controllers/chat-controlller')
...
router.get('/publicChatRoom', authenticated, chatController.renderPublicChatRoom)
router.get('/privateChatRoom/:id', authenticated, chatController.renderPrivateChatRoom)
router.get('/privateChatRoom', authenticated, chatController.renderPrivateChatRoom)
